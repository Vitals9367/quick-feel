...
export const metadata: Metadata = {
  ...
  description:
    "Read our terms of service to understand the rules and guidelines for using QuickFeel.",
};
      ...
      <div className="container max-w-3xl px-4 py-12">
        ...
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <p>
              By accessing or using QuickFeel's services, you agree to be bound
          ...
          <section className="space-y-4">
            ...
            <p>
              Subject to your compliance with these Terms, QuickFeel grants you
              a limited, non-exclusive, non-transferable, and revocable license
              to access and use our services for your internal business
              purposes.
            </p>
          ...
          <section className="space-y-4">
            ...
            <p>
              By selecting a paid subscription, you agree to pay QuickFeel the
              monthly or annual subscription fees indicated. Payments will be
              charged on a pre-pay basis on the day you sign up and will cover
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              are owned by QuickFeel and are protected by international
          ...
          <section className="space-y-4">
            ...
            <p>
              In no event shall QuickFeel, nor its directors, employees,
          ...
          <section className="space-y-4">
            ...
            <p>
              ...
              <Link
                href="mailto:legal@quickfeel.com"
