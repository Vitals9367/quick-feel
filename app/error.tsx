      ...
      <div className="container px-4 md:px-6 flex flex-col items-center text-center space-y-4">
        ...
        <div className="space-y-6 max-w-[600px]">
          ...
          <p className="mx-auto max-w-[600px] text-gray-500 md:text-xl/relaxed">
            We apologize, but we're having some technical difficulties. Our team
            has been notified and is working on the fix.
          </p>
        ...
        <div className="mt-8 text-sm text-gray-500">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-2">
            ...
            <Link href="/status" className="text-[#2A9D8F] hover:underline">
              System Status
            </Link>
          </div>
        </div>
