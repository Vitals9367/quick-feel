    ...
    <section className="w-full py-24 bg-[#1D3557] text-white overflow-hidden">
      ...
      >
        ...
        <p className="mx-auto max-w-[700px] text-gray-300 md:text-xl">
          Take the guesswork out of improving your business. QuickFeel makes it
          easy to turn feedback into growth.
        </p>
        <div className="flex flex-col items-center space-y-8">
          ...
          <p className="text-gray-300 text-sm mt-4">
            Join hundreds of businesses already using QuickFeel to transform
