...
const feedbackItems = [
  ...
  },
  {
    ...
    sentiment: "negative",
    content:
      "Had trouble connecting my account with the API. The error messages weren't very helpful.",
  ...
  },
  {
    ...
    sentiment: "neutral",
    content:
      "The export feature works well, but it would be nice to have more format options.",
    source: "In-App",
    time: "1 hour ago",
  },
  {
    ...
    sentiment: "positive",
    content:
      "Customer support team was extremely helpful in resolving my integration issues.",
    source: "Trustpilot",
    time: "2 hours ago",
  },
];
